...
public class JointPositionControl2M : MonoBehaviour
{
    private GameObject _kinectBodySource;
    private KinectBodySource2M _bodySourceManager;
    ...
    void Start()
    {
        ...
        if (_kinectBodySource != null)
            _bodySourceManager = _kinectBodySource.GetComponent<KinectBodySource2M>();
