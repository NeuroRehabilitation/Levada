...
public class _30sChairStandTest_Logger
{
    ...
    private void Initialize()
    {
        ...
        _filename = _userId + "_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + "_30sChairStand_" + TestDetails.TestDesc.Feedback;
        ...
        var fileHeader = new List<string>
        {
            ...
            "HalfStand",
            "SitToStandProgess",
            "ProgressStandThreshold",
            "ProgressHalfThreshold",
            "ProgressSitThreshold",
        };
    ...
    // Update log
    public void Log(float time, _30sChairStandTest_Manager.Test test, JointOrientationControl2M joints)
    {
        if (!_initialized)
            Initialize();
        ...
        List<string> newline = new List<string>
        {
            ...
            test.Stands.ToString(),
            test.UserWasDown.ToString(),
            test.HalfStand.ToString(),
            test.SitToStandProgess[0].ToString(CultureInfo.InvariantCulture),
            _30sChairStandTest_Manager.Test.ProgressStandThreshold.ToString(CultureInfo.InvariantCulture),
            _30sChairStandTest_Manager.Test.ProgressHalfThreshold.ToString(CultureInfo.InvariantCulture),
            _30sChairStandTest_Manager.Test.ProgressSitThreshold.ToString(CultureInfo.InvariantCulture),
        };
