...
public class KinectBodySource2M : MonoBehaviour
{
    ...
    {
        Kinect.transform.position = TestDetails.KinectDesc.Position;
        Kinect.transform.rotation = TestDetails.KinectDesc.Rotation;
    }
